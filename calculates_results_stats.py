...
def calculates_results_stats(results_dic):
    ...
    for filename, entry in results_dic.items():
        n_dogs_img += entry[3]
        n_match += entry[3] == entry[4]
        n_correct_dogs += entry[3] and entry[4]
        n_correct_notdogs += (not entry[3]) and (not entry[4])
        n_correct_breed += entry[2] and entry[3]
    ...
    results_stats_dic['pct_correct_notdogs'] = n_correct_notdogs / results_stats_dic['n_notdogs_img']
